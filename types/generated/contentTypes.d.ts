...
export interface ApiMainAboutMainAbout extends Schema.SingleType {
  collectionName: 'main_abouts';
  info: {
    singularName: 'main-about';
    pluralName: 'main-abouts';
    displayName: 'Main About';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::main-about.main-about': ApiMainAboutMainAbout;
